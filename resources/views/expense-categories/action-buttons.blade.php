<td>
    <a class="btn btn-sm btn-secondary btn-flex btn-center btn-active-light-primary" data-kt-menu-trigger="click"
    ...
    <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px"
        ...
        <div class="px-3 menu-item">
            <a href="{{ route('expense-category.show', $expenseCategory) }}" class="px-3 menu-link">
                <i class="fas fa-eye text-info font-weight-boldest me-2"></i>
                View
            </a>
        </div>
        <div class="px-3 menu-item">
            <a href="{{ route('expense-category.edit', $expenseCategory) }}" class="px-3 menu-link">
        ...
        <div class="px-3 menu-item">
            <span data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal"
                data-bs-url="{{ route('expense-category.destroy', $expenseCategory) }}">
