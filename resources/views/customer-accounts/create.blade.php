...
@section('toolbar')
    ...
    <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1">
            <a href="{{ route('customer.show', $customer) }}" class="text-blue-700 text-hover-primary me-1">
                Go Back
            </a>
        </li>
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1">Create Customer Account</li>
    </ul>
@endsection
    ...
    <div class="shadow-sm card">
        <div class="card-header">
            <div class="card-title">
                <h2>Create {{ $customer->name }}'s Account</h2>
            </div>
        </div>

        <form action="{{ route('customer-account.store', $customer) }}" class="form" method="post"
