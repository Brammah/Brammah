...
@section('toolbar')
    <div class="page-title d-flex flex-column me-3">
        ...
        <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
            ...
            <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
            <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> Payment Terms </li>
        </ul>
    </div>
    ...
    <div class="shadow-sm card">
        <div class="mt-5 card-header">
            <div class="card-title flex-column">
                <h3 class="mb-1 fw-bold">Payment Terms</h3>
                <div class="mb-2 text-gray-400 ">List of Payment Terms</div>
            </div>

            <div class="my-1 card-toolbar">
                @can('add payment term')
                    <a href="{{ route('payment-term.create') }}" class="btn btn-primary btn-sm">
                        New Payment Term
                    </a>
                @endcan
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="#" method="POST" id="form_payment_term_delete">
                        @csrf
                        @method('DELETE')
...
@section('js')
    <script>
        $(function() {
            const table = $('#payment-terms-table').DataTable({
                processing: true,
                serverSide: true,
                dom: "<'row'" +
            ...
            const deleteForm = document.getElementById('form_payment_term_delete')
