...
@section('toolbar')
    <div class="page-title d-flex flex-column me-3">
        <h1 class="m-0 text-gray-900 fs-2 fw-bold">Agent Earnings</h1>
        <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
            ...
            <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
            <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> Agent Earnings</li>
        </ul>
    </div>
    ...
    <div class="shadow-sm card">
        <div class="mt-5 card-header">
            <div class="card-title flex-column">
                <h3 class="mb-1 fw-bold">Agent Earnings</h3>
                <div class="mb-2 text-gray-400 ">List of Agent Earnings</div>
            </div>
        </div>
...
@section('js')
    <script>
        $(function() {
            const table = $('#agent-earnings-table').DataTable({
                processing: true,
                serverSide: true,
                dom: "<'row'" +
                    ...
                    },
                    {
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, node, config) {
                                    const url = "{{ route('agent-earnings.excel-export') }}";
                                    window.location = url;
                                },
                            },
                            {
