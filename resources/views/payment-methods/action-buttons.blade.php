  @canany(['edit payment method', 'delete payment method', 'view payment method'])
      <td>
          ...
          <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px"
              ...
              @can(['edit payment method'])
                  <div class="px-3 menu-item">
                      <a href="{{ route('payment-method.edit', $paymentMethod) }}" class="px-3 menu-link">
              ...
              @can(['delete payment method'])
                  <div class="px-3 menu-item">
                      <span data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal"
                          data-bs-url="{{ route('payment-method.destroy', $paymentMethod) }}">
