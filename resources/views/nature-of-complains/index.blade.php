...
@section('title', 'Nature Of Complains')

@section('toolbar')
    <h1 class="m-0 text-gray-900 fs-2 fw-bold">Nature Of Complains</h1>
    <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> Nature Of Complains </li>
    </ul>
@endsection
    ...
    <div class="shadow-sm card">
        <div class="mt-5 card-header">
            <div class="card-title flex-column">
                <h3 class="mb-1 fw-bold">Nature Of Complains</h3>
                <div class="mb-2 text-gray-400 ">List of Nature Of Complains</div>
            </div>

            <div class="my-1 card-toolbar">
                @can('add nature of complain')
                    <a href="{{ route('nature-of-complain.create') }}" class="btn btn-primary btn-sm">
                        New Nature Of Complain
                    </a>
                @endcan
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete this Nature Of Complain?</p>
                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-light-secondary text-dark font-weight-bold hover-scale"
                        data-bs-dismiss="modal">Cancel</button>
                    <form action="#" method="POST" id="form_nature_of_complain_delete">
                        @csrf
                        @method('DELETE')
...
@section('js')
    <script>
        $(function() {
            const table = $('#natureOfComplains-table').DataTable({
                processing: true,
                serverSide: true,
                dom: "<'row'" +
                    ...
                    ">",
                ajax: {
                    url: "{{ route('nature-of-complain.index') }}",
                    type: "GET"
                },
                buttons: [{
                        extend: "pageLength",
            ...
            const deleteForm = document.getElementById('form_nature_of_complain_delete')
