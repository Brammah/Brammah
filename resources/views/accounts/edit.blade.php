...
@section('header')
    ...
    <ul class="pt-1 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="breadcrumb-item text-muted">
            <a href="{{ route('account.index') }}" class="text-dark text-hover-primary">Go Back</a>
        </li>
        <li class="breadcrumb-item">
            <span class="bg-gray-300 bullet w-5px h-2px"></span>
        </li>
        <li class="text-gray-900 breadcrumb-item">Edit Account</li>
    </ul>
@endsection
...
@section('main-content')
    <div class="shadow-sm card">
        ...
        <form action="{{ route('account.update', $account) }}" class="form" method="post" accept-charset="utf-8">
            @csrf
            @method('PATCH')
            <div class="card-body">
