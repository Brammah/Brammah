  @canany(['edit payment term', 'delete payment term', 'view payment term'])
      <td>
          ...
          <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px"
              data-kt-menu="true">
              @can(['edit payment term'])
                  <div class="px-3 menu-item">
                      <a href="{{ route('payment-term.edit', $paymentTerm) }}" class="px-3 menu-link">
              ...
              @can(['delete payment term'])
                  <div class="px-3 menu-item">
                      <span data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal"
                          data-bs-url="{{ route('payment-term.destroy', $paymentTerm) }}">
