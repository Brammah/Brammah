...
@section('header')
    ...
    <ul class="pt-1 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="text-gray-900 breadcrumb-item">Edit Account Category</li>
    </ul>
@endsection
    ...
    <div class="shadow-sm card">
        <div class="card-header">
            <div class="card-title">
                <h2>Edit Account Category</h2>
            </div>
        </div>

        <form action="{{ route('account-category.update', $accountCategory) }}" class="form" method="post"
