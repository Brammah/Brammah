...
@section('toolbar')
    <div class="page-title d-flex flex-column me-3">
        <h1 class="m-0 text-gray-900 fs-2 fw-bold">Customer Contacts</h1>
        <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
            ...
            <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
            <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> Customer Contacts</li>
        </ul>
    </div>
    ...
    <div class="card">
        <div class="mt-5 card-header">
            <div class="card-title flex-column">
                <h3 class="mb-1 fw-bold">Customer Contacts</h3>
                <div class="mb-2 text-gray-400 ">List of Customer Contacts</div>
            </div>

            <div class="my-1 card-toolbar">
                @can('add customer contact')
                    <a href="{{ route('customer-contact.create') }}" class="btn btn-primary btn-sm">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Are you sure you want to delete this Customer Contact?</p>
                </div>

                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-light-secondary text-dark font-weight-bold hover-scale"
                        data-bs-dismiss="modal">Cancel</button>
                    <form action="#" method="POST" id="form_customer_contact_delete">
                        @csrf
                        @method('DELETE')
...
@section('js')
    <script>
        $(function() {
                    ...
                    },
                    {
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, node, config) {
                                    const url = "{{ route('customer-contact.excel-export') }}";
                                    window.location = url;
                                },
                            },
                            {
            ...
            const deleteForm = document.getElementById('form_customer_contact_delete')
