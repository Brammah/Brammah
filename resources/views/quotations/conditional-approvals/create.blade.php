...
@section('title', 'Conditionally Approve')

@section('toolbar')
    <h1 class="m-0 text-gray-900 fs-2 fw-bold">Permissions</h1>
    <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> User Management </li>
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1">
            <a href="{{ route('permission.index') }}" class="text-blue-700 text-hover-primary me-1">
                Go Back
            </a>
        </li>
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1">Conditionally Approve</li>
    </ul>
@endsection
    ...
    <div class="shadow-sm card">
        <div class="card-header">
            <div class="card-title">
                <h2>Conditionally Approve</h2>
            </div>
        </div>

        <form action="{{ route('conditional-approval.store', $quotation) }}" class="form" method="post"
            accept-charset="utf-8">
            @csrf
            <div class="card-body">
                @include('quotations.conditional-approvals.form')
            </div>
...
@section('js')
    <script>
        $(function() {
            const proposedPaymentDate = $('#proposed_payment_date');

            proposedPaymentDate.flatpickr({
                dateFormat: "Y-m-d",
            });
        });
    </script>
