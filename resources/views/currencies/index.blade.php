...
@section('toolbar')
    <div class="page-title d-flex flex-column me-3">
        <h1 class="m-0 text-gray-900 fs-2 fw-bold">Currencies</h1>
        <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
            ...
            <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
            <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> Currencies</li>
        </ul>
    </div>
    ...
    <div class="shadow-sm card">
        <div class="mt-5 card-header">
            <div class="card-title flex-column">
                <h3 class="mb-1 fw-bold">Currencies</h3>
                <div class="mb-2 text-gray-400 ">List of Currencies</div>
            </div>

            <div class="my-1 card-toolbar">
                @can('add currency')
                    <a href="{{ route('currency.create') }}" class="btn btn-primary btn-sm">New Currency</a>
                @endcan
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="#" method="POST" id="form_currency_delete">
                        @csrf
                        @method('DELETE')
...
@section('js')
    <script>
        $(function() {
            const table = $('#currencies-list').DataTable({
                processing: true,
                serverSide: true,
                dom: "<'row'" +
            ...
            const deleteForm = document.getElementById('form_currency_delete')
