...
@section('toolbar')
    ...
    <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1">Edit Payment Term</li>
    </ul>
@endsection
    ...
    <div class="shadow-sm card">
        <div class="card-header">
            <div class="card-title">
                <h2>Edit Payment Term</h2>
            </div>
        </div>

        <form action="{{ route('payment-term.update', $paymentTerm) }}" class="form" method="post"
