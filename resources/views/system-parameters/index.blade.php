...
@section('toolbar')
    ...
    <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> System Parameters </li>
    </ul>
@endsection
    ...
    <div class="shadow-sm card">
        <div class="mt-5 card-header">
            <div class="card-title flex-column">
                <h3 class="mb-1 fw-bold">System Parameters</h3>
                <div class="mb-2 text-gray-400 ">List of System Parameters</div>
            </div>

            <div class="my-1 card-toolbar">
                @can('add system parameter')
                    <a href="{{ route('system-parameter.create') }}" class="btn btn-primary btn-sm">
...
@section('js')
    <script>
        $(function() {
            const table = $('#system-parameters-table').DataTable({
                processing: true,
                serverSide: true,
                dom: "<'row'" +
                    ...
                    ">",
                ajax: {
                    url: "{{ route('system-parameter.index') }}",
                    type: "GET"
                },
                buttons: [{
                        extend: "pageLength",
            ...
            const deleteForm = document.getElementById('form_brand_delete')
