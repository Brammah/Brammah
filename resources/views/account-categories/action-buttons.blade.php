  @canany(['edit account category', 'delete account category', 'view account category'])
      <td>
          ...
          <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px"
              data-kt-menu="true">
              @can(['edit account category'])
                  <div class="px-3 menu-item">
                      <a href="{{ route('account-category.edit', $accountCategory) }}" class="px-3 menu-link">
              ...
              @can(['delete account category'])
                  <div class="px-3 menu-item">
                      <span data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal"
                          data-bs-url="{{ route('account-category.destroy', $accountCategory) }}">
