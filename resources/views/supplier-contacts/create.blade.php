...
@section('title', 'Create Supplier Contact')
...
@section('toolbar')
    ...
    <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1">
            <a href="{{ route('supplier-contact.index') }}" class="text-blue-700 text-hover-primary me-1">
                Go Back
            </a>
        </li>
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1">Create Supplier Contact</li>
    </ul>
@endsection
    ...
    <div class="card">
        <div class="card-header">
            <div class="card-title">
                <h2>Create Supplier Contact</h2>
            </div>
        </div>

        <form action="{{ route('supplier-contact.store') }}" class="form" method="post" accept-charset="utf-8">
            @csrf
            <div class="card-body">
                @include('supplier-contacts.form')
            </div>
