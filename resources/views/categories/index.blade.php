...
@section('toolbar')
    <h1 class="m-0 text-gray-900 fs-2 fw-bold">Categories</h1>
    <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> Inventory Management </li>
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> Categories </li>
    </ul>
@endsection
    ...
    <div class="shadow-sm card">
        <div class="mt-5 card-header">
            <div class="card-title flex-column">
                <h3 class="mb-1 fw-bold">Categories</h3>
                <div class="mb-2 text-gray-400 ">List of Categories</div>
            </div>

            <div class="my-1 card-toolbar">
                @can('add category')
                    <a href="{{ route('category.create') }}" class="btn btn-primary btn-sm">New Category</a>
                @endcan
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="#" method="POST" id="form_category_delete">
                        @csrf
                        @method('DELETE')
...
@section('js')
    <script>
        $(function() {
            ...
            const deleteForm = document.getElementById('form_category_delete')
