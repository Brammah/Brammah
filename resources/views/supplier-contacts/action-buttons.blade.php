  @canany(['edit supplier contact', 'delete supplier contact', 'view supplier contact'])
      <td>
          ...
          <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px"
              data-kt-menu="true">
              @can(['edit supplier contact'])
                  <div class="px-3 menu-item">
                      <a href="{{ route('supplier-contact.edit', $supplierContact) }}" class="px-3 menu-link">
              ...
              @can(['delete supplier contact'])
                  <div class="px-3 menu-item">
                      <span data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal"
                          data-bs-url="{{ route('supplier-contact.destroy', $supplierContact) }}">
