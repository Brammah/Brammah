...
@section('toolbar')
    <div class="page-title d-flex flex-column me-3">
        <h1 class="m-0 text-gray-900 fs-2 fw-bold">Terms & Conditions</h1>
        <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
            ...
            <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
            <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> Terms & Conditions</li>
        </ul>
    </div>
    ...
    <div class="shadow-sm card">
        <div class="mt-5 card-header">
            <div class="card-title flex-column">
                <h3 class="mb-1 fw-bold">Terms & Conditions</h3>
                <div class="mb-2 text-gray-400 ">List of Terms & Conditions</div>
            </div>

            <div class="my-1 card-toolbar">
                @can('add terms and conditions')
                    <a href="{{ route('terms-and-condition.create') }}" class="btn btn-primary btn-sm">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="#" method="POST" id="form_terms_and_conditions_delete">
                        @csrf
                        @method('DELETE')
...
@section('js')
    <script>
        $(function() {
            const table = $('#terms-and-conditions-list').DataTable({
                processing: true,
                serverSide: true,
                dom: "<'row'" +
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            return `<a href="#" class="text-dark conditions-tooltip"
                                id="tooltip-${meta.row}"
                                data-bs-toggle="tooltip"
                                data-bs-placement="top"
                                title="${data}">
                                ${data.length > 20 ? data.substr(0, 20) + '...' : data}
                            </a>`;
                        }
                    },
                    {
            ...
            const deleteForm = document.getElementById('form_terms_and_conditions_delete')
