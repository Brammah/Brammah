...
@section('toolbar')
    ...
    <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1">Edit System Parameter</li>
    </ul>
@endsection
    ...
    <div class="shadow-sm card">
        <div class="card-header">
            <div class="card-title">
                <h2>Edit System Parameter</h2>
            </div>
        </div>

        <form action="{{ route('system-parameter.update', $systemParameter) }}" class="form" method="post"
