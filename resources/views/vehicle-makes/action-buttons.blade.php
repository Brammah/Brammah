  @canany(['edit vehicle make', 'delete vehicle make', 'view vehicle make'])
      <td>
          ...
          <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px"
              data-kt-menu="true">
              {{-- @can('view vehicle make')
                  <div class="px-3 menu-item">
                      <a href="{{ route('vehicle-make.show', $vehicleMake) }}" class="px-3 menu-link">
              ...
              @can(['edit vehicle make'])
                  <div class="px-3 menu-item">
                      <a href="{{ route('vehicle-make.edit', $vehicleMake) }}" class="px-3 menu-link">
              ...
              @can(['delete vehicle make'])
                  <div class="px-3 menu-item">
                      <span data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal"
                          data-bs-url="{{ route('vehicle-make.destroy', $vehicleMake) }}">
