                    ...
                    <div>
                        <table>
                            <td class="w-half">
                                ...
                                <div class="system-info" style="text-align: right;">
                                    <b>Invoice Number:</b> {{ $data['invoiceNumber'] }}
                                </div>
                    ...
                    <tr>
                        <td class="w-half">
                            <div style="text-align: right; margin-bottom:3px;">
                                <b>Subtotal: </b>{{ $data['invoiceAmount'] }}
                            </div>
                            <div style="text-align: right; margin-bottom:3px;">
                            ...
                            <div style="text-align: right; margin-bottom:3px;">
                                <b> VAT ({{ $data['vatPercentage'] }} %):</b> {{ $data['invoiceVatAmount'] }}
                            </div>
                            <div style="text-align: right; margin-bottom:3px;">
                                <b>Total - {{ $data['currency'] }}: </b> {{ $data['invoiceAmountInclusiveVat'] }}
                            </div>
                            <div style="text-align: right; margin-bottom:3px;">
                                ({{ $data['invoiceCostToWords'] }})
                            </div>
                        </td>
                    </tr>
                </table>
