  @canany(['edit terms and conditions', 'delete terms and conditions', 'view terms and conditions'])
      <td>
          ...
          <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px"
              ...
              @can(['edit terms and conditions'])
                  <div class="px-3 menu-item">
                      <a href="{{ route('terms-and-condition.edit', $termsAndCondition) }}" class="px-3 menu-link">
              ...
              @can(['delete terms and conditions'])
                  <div class="px-3 menu-item">
                      <span data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal"
                          data-bs-url="{{ route('terms-and-condition.destroy', $termsAndCondition) }}">
