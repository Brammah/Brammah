  @canany(['edit nature of complain', 'delete nature of complain', 'view nature of complain'])
      <td>
          ...
          <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px"
              data-kt-menu="true">
              @can(['edit nature of complain'])
                  <div class="px-3 menu-item">
                      <a href="{{ route('nature-of-complain.edit', $natureOfComplain) }}" class="px-3 menu-link">
              ...
              @can(['delete nature of complain'])
                  <div class="px-3 menu-item">
                      <span data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal"
                          data-bs-url="{{ route('nature-of-complain.destroy', $natureOfComplain) }}">
