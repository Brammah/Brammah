...
@section('toolbar')
    <h1 class="m-0 text-gray-900 fs-2 fw-bold">Branches</h1>
    <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1">
            <a href="{{ route('branch.index') }}" class="text-blue-700 text-hover-primary me-1">
                Go Back
            </a>
        </li>
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1">{{ $branch->name }} Details</li>
    </ul>
@endsection
    ...
    <div class="mb-5 card mb-xxl-8">
        <div class="pb-0 card-body">
            <div class="table-responsive">
                <table id="treatment-payment-services-list"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="#" method="POST" id="form_client_invoice">
                        @csrf
...
@section('js')
    <script>
        $(function() {
            initializeDatatable('treatment-payment-services-list');

            const deleteConfirmationModal = document.getElementById('deleteConfirmationModal')
            const invoiceForm = document.getElementById('form_client_invoice')
