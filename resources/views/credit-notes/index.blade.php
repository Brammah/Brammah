...
@section('toolbar')
    <div class="page-title d-flex flex-column me-3">
        ...
        <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
            ...
            <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
            <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> Credit Notes </li>
        </ul>
    </div>
    ...
    <div class="shadow-sm card">
        <div class="mt-5 card-header">
            <div class="card-title flex-column">
                <h3 class="mb-1 fw-bold">Credit Notes</h3>
                <div class="mb-2 text-gray-400 ">List of Credit Notes</div>
            </div>

            <div class="my-1 card-toolbar">
                @can('add invoice')
                    <a href="{{ route('credit-note.create') }}" class="btn btn-primary btn-sm">
                        New Credit Note
                    </a>
                @endcan
            </div>
                ...
                <table class="table align-middle border rounded table-striped table-row-bordered gy-2 gs-4 fs-7"
                    ...
                    <thead>
                        <tr class="align-middle text-start fw-bold fs-7 text-uppercase gs-0">
                            ...
                            <th>Customer</th>
                            <th>Currency</th>
                            <th>Credit Note Amount Inclsv</th>
        ...
        $(function() {
            const table = $('#credit-notes-table').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'credit_note_amount_inclusive_vat',
                        name: 'credit_note_amount_inclusive_vat'
                    },
                    {
                        data: 'is_approved',
                        name: 'is_approved'
            ...
            const approveForm = document.getElementById('form_credit_note_approve')
