  @canany(['edit category', 'delete category', 'view category'])
      <td>
          ...
          <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px"
              ...
              {{-- @can('view category')
                  <div class="px-3 menu-item">
                      <a href="{{ route('category.show', $category) }}" class="px-3 menu-link">
              ...
              @can(['edit category'])
                  <div class="px-3 menu-item">
                      <a href="{{ route('category.edit', $category) }}" class="px-3 menu-link">
              ...
              @can(['delete category'])
                  <div class="px-3 menu-item">
                      <span data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal"
                          data-bs-url="{{ route('category.destroy', $category) }}">
