...
@section('toolbar')
    <h1 class="m-0 text-gray-900 fs-2 fw-bold">Terms And Conditionss</h1>
    <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1">Edit Terms And Conditions</li>
    </ul>
@endsection
...
@section('main-content')
    <div class="shadow-sm card">
        ...
        <form action="{{ route('terms-and-condition.update', $termsAndCondition) }}" class="form" method="post"
