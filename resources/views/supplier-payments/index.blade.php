...
@section('toolbar')
    <div class="page-title d-flex flex-column me-3">
        ...
        <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
            ...
            <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
            <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> Supplier Payments </li>
        </ul>
    </div>
    ...
    <div class="shadow-sm card">
        <div class="mt-5 card-header">
            <div class="card-title flex-column">
                <h3 class="mb-1 fw-bold">Supplier Payments</h3>
                <div class="mb-2 text-gray-400 ">List of Supplier Payments</div>
            </div>

            <div class="my-1 card-toolbar">
                @can('add supplier payment')
                    <a href="{{ route('supplier-payment.create') }}" class="btn btn-primary btn-sm">
...
@section('js')
    <script>
        $(function() {
            const table = $('#supplier-payments-table').DataTable({
                processing: true,
                serverSide: true,
                dom: "<'row'" +
                    ...
                    ">",
                ajax: {
                    url: "{{ route('supplier-payment.index') }}",
                    type: "GET"
                },
                buttons: [{
                        extend: "pageLength",
