...
@section('toolbar')
    ...
    <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
        ...
        <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
        <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> Branches </li>
    </ul>
@endsection
    ...
    <div class="shadow-sm card">
        <div class="mt-5 card-header">
            <div class="card-title flex-column">
                <h3 class="mb-1 fw-bold">Branches</h3>
                <div class="mb-2 text-gray-400 ">List of Branches</div>
            </div>

            <div class="my-1 card-toolbar">
                @can('add branch')
                    <a href="{{ route('branch.create') }}" class="btn btn-primary btn-sm">New Branch</a>
                @endcan
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="#" method="POST" id="form_branch_delete">
                        @csrf
                        @method('DELETE')
...
@section('js')
    <script>
        $(function() {
            ...
            const deleteForm = document.getElementById('form_branch_delete')
