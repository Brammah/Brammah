  @canany(['edit branch', 'delete branch', 'view branch'])
      <td>
          ...
          <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px"
              ...
              {{-- @can('view branch')
                  <div class="px-3 menu-item">
                      <a href="{{ route('branch.show', $branch) }}" class="px-3 menu-link">
              ...
              @can(['edit branch'])
                  <div class="px-3 menu-item">
                      <a href="{{ route('branch.edit', $branch) }}" class="px-3 menu-link">
              ...
              @can(['delete branch'])
                  <div class="px-3 menu-item">
                      <span data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal"
                          data-bs-url="{{ route('branch.destroy', $branch) }}">
