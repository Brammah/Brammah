  @canany(['edit vehicle', 'delete vehicle', 'view vehicle'])
      <td>
          ...
          <div class="py-4 menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px"
              ...
              {{-- @can('view vehicle ')
                  <div class="px-3 menu-item">
                      <a href="{{ route('vehicle.show', $vehicle) }}" class="px-3 menu-link">
              ...
              @can(['edit vehicle '])
                  <div class="px-3 menu-item">
                      <a href="{{ route('vehicle.edit', $vehicle) }}" class="px-3 menu-link">
              ...
              @can(['delete vehicle '])
                  <div class="px-3 menu-item">
                      <span data-bs-toggle="modal" data-bs-target="#deleteConfirmationModal"
                          data-bs-url="{{ route('vehicle.destroy', $vehicle) }}">
