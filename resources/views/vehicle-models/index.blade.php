...
@section('toolbar')
    <div class="page-title d-flex flex-column me-3">
        <h1 class="m-0 text-gray-900 fs-2 fw-bold">Vehicle Models</h1>
        <ul class="mt-2 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
            ...
            <li class="breadcrumb-item"> <i class="text-gray-500 ki-outline ki-right fs-7 mx-n1"></i> </li>
            <li class="text-gray-600 breadcrumb-item fw-bold lh-1"> Vehicle Models</li>
        </ul>
    </div>
    ...
    <div class="shadow-sm card">
        <div class="mt-5 card-header">
            <div class="card-title flex-column">
                <h3 class="mb-1 fw-bold">Vehicle Models</h3>
                <div class="mb-2 text-gray-400 ">List of Vehicle Models</div>
            </div>

            <div class="my-1 card-toolbar">
                @can('add vehicle model')
                    <a href="{{ route('vehicle-model.create') }}" class="btn btn-primary btn-sm">
                        New Vehicle Model
                    </a>
                @endcan
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form action="#" method="POST" id="form_vehicle_model_delete">
                        @csrf
                        @method('DELETE')
...
@section('js')
    <script>
        $(function() {
            const table = $('#vehicle-models-table').DataTable({
                processing: true,
                serverSide: true,
                dom: "<'row'" +
                    ...
                    },
                    {
                        ...
                        buttons: [{
                                ...
                                action: function(e, dt, node, config) {
                                    const url =
                                        "{{ route('vehicle-models.excel-export') }}";
                                    window.location = url;
                                },
                            },
                            {
            ...
            const deleteForm = document.getElementById('form_vehicle_model_delete')
